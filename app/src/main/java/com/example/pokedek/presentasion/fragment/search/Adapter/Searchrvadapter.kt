package com.example.pokedek.presentasion.fragment.search.Adapter
...
//                holder.itemView.findNavController().navigate(SearchfragmentDirections.actionSearchfragmentToPokemondetailfragment(arrList))
